...
var div = L.DomUtil.create('div', 'info2');
	 div.innerHTML +=
	 'VISOR CARTOGRÁFICO<h2>Baròmetre de Violència Masclista de Catalunya 2019';
	 return div;
	};
	title2.addTo(map);
//Logo Matrix	
...
function popup3(feature, layer) {
	...
	if (feature.properties && feature.properties.COD_PJ) {
		layer.bindTooltip("<div id='custom'>"
			...
			"‰<br><strong>Partit judicial: </strong>"+
			feature.properties.PARTIDO_JU+
			"<br><strong>Municipis: <br></strong>"+ 
...
function getColor4(a) {
	return a == 'Creixement molt alt' ? '#D7696A' :
	a == 'Creixement alt' ? '#FCC664' :
	a == 'Creixement moderat'? '#F8F266' :
	a == 'Decreixement'? '#B2D88F': 
	'#C2523C';
};
function style4(feature) {
	return {
		fillColor: getColor4(feature.properties.Cambi_CT),
		weight: 0.5,
		opacity: 0.60,
		color: '#000000',
		dashArray: '1',
	...
	if (feature.properties && feature.properties.COD_PJ) {
		layer.bindTooltip("<div id='custom'>"
            +"<strong>Situació: </strong>"+  
			 feature.properties.S_D_CT+
		    "<br><strong>Taxa: </strong>"+  
			 feature.properties.Vio_14_18.toString().replace(".", ",")+
			 "‰<br><strong>Canvi: </strong>"+  
			 feature.properties.Cambi_CAT+
			"<br><strong>Partit judicial: </strong>"+
			feature.properties.PARTIDO_JU+
			"<br><strong>Municipis: <br></strong>"+ 
			feature.properties.NAME_MUNIC.split(';').slice().sort().join("<br>").fontsize(1)+"</div>",
...
var baseTree = [
	{ label: "<strong>Netejar mapa", layer: osm3 },
	{
	label: '<strong>Mapes de violència de masclista ',
	children: [
	
	    { label: "Model espacial de violència masclista",layer: mapa1},
		{ label: "Taxa de violència masclista",layer: mapa2},
	    { label: "Canvi de la violència masclista",layer: mapa3},
		{ label: "Situació detallada de la violència masclista",layer: mapa4}
...
var htmlLegend1 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Model espacial de violència masclista'+"<\h3>",
		image:'<img src="images/LOGO_GEN.png"',
			...
			elements: [{
				...
				label:"<h4>"+  'Taxa anual mitjana de denúncies per violècia de gènere (TD). Període 2014-2018.<br>'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:'<img src="images/formula.jpg",></img><br>',
				IMG:"<h3>"+  'Unitats : ‰'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:"<h3>"+  'Unitats : ‰'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {	
				...
				label:"<h5>"+  'Isolínea de taxa de violència de gènere'+"<\h5>",html: '',style: {'background-color': '#000000','width': '40px','height': '1px'}}, {
				label: "<h5>" +'<BR><i>Font: Elaboració pròpia amb dades del Consell del Poder Judicial (2019).<i><BR>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}																
	...
	var htmlLegend2 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Taxa de violencia masclista per partits judicials'+"<\h3>",
			style: style3,
			layer: geojson3,
			elements: [{
				...
				label:"<h3>"+  '<strong>Unitats : ‰'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:"<h4>"+  '2,6 - 3,0'+"<\h4>",html: '',style: {'background-color': '#99CF9B','width': '40px','height': '14px', 'border': 'black 1px solid'}}, { 
			    label:"<h4>"+  '3,1 - 3,5'+"<\h4>",html: '',style: {'background-color': '#ADD797','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  '3,6 - 4,0'+"<\h4>",html: '',style: {'background-color': '#C1DD90','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  '4,1 - 4,5'+"<\h4>",html: '',style: {'background-color': '#D6E78B','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {		
	...
	// leyenda cambio
		...
		position: 'bottomleft',
		legends: [{
			name: "<h3>"+ 'Canvi de la violència masclista per partits judicials'+"<\h3>",
			style: style4,
			layer: geojson4,
			elements: [{
                ...
                label:"<h5>"+'<br>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
                label:"<h4>"+  'Canvi relatiu de la taxa anual mithana de denunciès per violncia de gènerè del periode 2009-2013 al periode 2014-2018.<br>'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
				label:"<h5>"+'<br>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
				label:"<h3>"+  '<strong>Categories de canvi'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:"<h5>"+'<br>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
				label:"<h4>"+  'Creixement molt alt'+"<\h4>",html: '',style: {'background-color': '#D7696A','width': '40px','height': '14px', 'border': 'black 1px solid'}}, { 
			    label:"<h4>"+  'Creixement alt'+"<\h4>",html: '',style: {'background-color': '#FCC664','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  'Creixement moderat'+"<\h4>",html: '',style: {'background-color': '#F8F266','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  'Decreixement'+"<\h4>",html: '',style: {'background-color': '#B2D88F','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {		
				//label:"<h5>"+  ''+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label: "<h5>" +'<BR><i>Font: Elaboració pròpia amb dades del Consell del Poder Judicial (2019).<i><BR>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}																
			}]
		}],
	...
	// leyenda situación detallada
		...
		legends: [{
			label:+'<br>',
			name: "<h3>"+ 'Situació detallada de violència masclista per partits judicials<br>'+"<\h3>",
			...
			elements: [{
                ...
                label:"<h5>"+'<br>'+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
                label:"<h4>"+  "Taxa anual mitjana de denúncies per violència de gènere (Periodo 2014-2018) i canvi relatiu respecte al període previ (2009-2013). El nombre de factors de risc presents s'indica mitjançant un codi de 0 a 4.<br>"+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, { 
				...
				label:"<h4>"+  'Greu (G-4)'+"<\h4>",html: '',style: {'background-color': '#F29136','width': '40px','height': '14px', 'border': 'black 1px solid'}}, { 
			    label:"<h4>"+  'Greu (G-3)'+"<\h4>",html: '',style: {'background-color': '#F2AF70','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  'Greu (G-2)'+"<\h4>",html: '',style: {'background-color': '#F2CDA9','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  'Greu (G-1)'+"<\h4>",html: '',style: {'background-color': '#F2EBE2','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  'En deteriorament (D-2)'+"<\h4>",html: '',style: {'background-color': '#FAE94C','width': '40px','height': '14px', 'border': 'black 1px solid'}}, { 
			    label:"<h4>"+  'En deteriorament (D-1)'+"<\h4>",html: '',style: {'background-color': '#F9EF93','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  'En deteriorament (D-0)'+"<\h4>",html: '',style: {'background-color': '#F9F6DA','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  'En observació (O-3)'+"<\h4>",html: '',style: {'background-color': '#9EF29E','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {	
				label:"<h4>"+  'En observació (O-2)'+"<\h4>",html: '',style: {'background-color': '#BDF5BE','width': '40px','height': '14px', 'border': 'black 1px solid'}}, { 
			    label:"<h4>"+  'En observació (O-1)'+"<\h4>",html: '',style: {'background-color': '#DCF9DD','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				label:"<h4>"+  'En observació (O-0)'+"<\h4>",html: '',style: {'background-color': '#FBFCFC','width': '40px','height': '14px', 'border': 'black 1px solid'}}, {
				//label:"<h5>"+  ''+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label: "<h5>" +"<BR><i><i>Font: Elaboració pròpia amb dades del Consell del Poder Judicial. (2019) i factors de risc socio-territorial derivats d'un model de regresió especific de Catalunya.<i><BR>"+"<\h5>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}																
			}]
		}],
		collapseSimple: true,  // if true, legend entries that are from a simple renderer will use compact presentation
		detectStretched: true,  // if true, will test to see if legend entries look stretched.  These are usually in sets of 3 with the middle element having no label.
